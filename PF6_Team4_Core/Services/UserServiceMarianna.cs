...
{
    public class UserServiceMarianna : IUserServiceAlkiviadis

    {
        private readonly IApplicationDbContext _context;
        private readonly ILogger<UserServiceMarianna> _logger;

        public UserServiceMarianna(IApplicationDbContext context, ILogger<UserServiceMarianna> logger)
        {
            _context = context;
            _logger = logger;
        }
